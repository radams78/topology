...
\begin{proof}
  ...
  \step{<1>8}{$\mathcal{E}$ is countably locally finite}
  \begin{proof}
    \step{<2>1}{For all $n$, $\mathcal{E}_n$ is locally finite.}
    \begin{proof}
...
\begin{thm}[Nagata-Smirnov Metrization Theorem]
  A space is metrizable if and only if it is regular and has a countably locally finite basis.
\end{thm}
\end{document}
