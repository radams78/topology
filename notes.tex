...
\item all sets of the form $(-a, 0) \cup \{ q \} \cup (0, a)$ where $a > 0$
 ...
 \end{df}
  ...
  \begin{proof}
    \pf
    \step{1}{\pflet{$\{A_i\}_{i \in I}$ be a locally finite family of subsets of the space $X$.}}
    \step{2}{\pflet{$x \in X$}}
    \step{3}{\pick\ a neighbourhood $U$ of $x$ that intersects only $A_{i_1}$, \ldots, $A_{i_n}$.}
    \step{4}{$U$ intersects only $\overline{A_{i_1}}$, \ldots, $\overline{A_{i_n}}$.}
    \qed
  \end{proof}
