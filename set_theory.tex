...
\begin{proof}
 \pf
 \step{<1>1}{\pflet{$A, B, C$ be sets.}}
 \step{<1>2}{\pflet{$f : A \rightarrow B$.}}
 \step{<1>3}{\pflet{$g : B \rightarrow C$.}}
 \step{<1>4}{\assume{$f$ is injective.}}
 \step{<1>5}{\assume{$g$ is injective.}}
 \step{<1>6}{\pflet{$X$ be a set and $x, y : X \rightarrow A$.}}
 \step{<1>7}{\assume{$g \circ f \circ x = g \circ f \circ y$} \prove{$x = y$}}
 \step{<1>8}{$f \circ x = f \circ y$}
 \begin{proof}
   \pf\ \stepref{<1>5}, \stepref{<1>7}
 \end{proof}
 \step{<1>9}{$x = y$}
 \begin{proof}
   \pf\ \stepref{<1>4}, \stepref{<1>8}
 \end{proof}
 \qed
\end{proof}
