...
\begin{proof}
  \pf
  \step{<1>1}{\pflet{$\mathbb{T}$ be a nonempty set of topologies on $X$.}}
  \step{<1>2}{$\emptyset \in \bigcap \mathbb{T}$}
  \begin{proof}
    \pf\ For all $\mathcal{T} \in \mathbb{T}$ we have $\emptyset \in \mathcal{T}$.
  \end{proof}
  \step{<1>3}{$X \in \bigcap \mathbb{T}$}
  \begin{proof}
    \pf\ For all $\mathcal{T} \in \mathbb{T}$ we have $X \in \mathcal{T}$.
  \end{proof}
  \step{<1>4}{For all $\mathcal{U} \subseteq \bigcap \mathbb{T}$ we have $\bigcup \mathcal{U} \in \bigcap \mathbb{T}$}
  \begin{proof}
    \step{<2>1}{\pflet{$\mathcal{U} \subseteq \bigcap \mathbb{T}$}}
    \step{<2>2}{\pflet{$\mathcal{T} \in \mathbb{T}$}}
    \step{<2>3}{$\mathcal{U} \subseteq \mathcal{T}$}
    \step{<2>4}{$\bigcup \mathcal{U} \in \mathcal{T}$}
  \end{proof}
  \step{<1>5}{For all $U, V \in \bigcap \mathbb{T}$ we have $U \cap V \in \bigcap \mathbb{T}$}
  \begin{proof}
    \step{<2>1}{\pflet{$U, V \in \bigcap \mathbb{T}$}}
    \step{<2>2}{\pflet{$\mathcal{T} \in \mathbb{T}$}}
    \step{<2>3}{$U, V \in \mathcal{T}$}
    \step{<2>4}{$U \cap V \in \mathcal{T}$}
  \end{proof}
  \qed
\end{proof}
